...
function checkVoteAge(){
    const age = 
    parseInt(document.getElementById("voteAgeInput").value);
        const message = age >= 18? `You are eligible to vote.` : `You are not able to vote`;
...
function checkPassword() {
    ...
    if (password.length >= 12){
        message = `Thats a strong password!`;
    }else if (password.length >= 8){
        message = `Thats a decent password.`;
    }else {
